...
public class ParkingChekout {
    ...
    public static final double DAY_VALUE = 20.00;
        ...
        private static Double getBill(LocalDateTime entryDate, LocalDateTime exitTime) {
            long minutes = entryDate.until(exitTime, ChronoUnit.MINUTES);
            Double bill = 0.0;
            if (minutes <= ONE_HOUR) {
